				...
				<div className="App">
					<nav className="navbar navbar-expand-sm navbar-dark bg-dark">
						...
						<div className="collapse navbar-collapse">
							<ul className="navbar-nav mr-auto">
								...
								<li className='nav-item'>
									<NavLink to="/all-staffFarmasi" exact className="nav-link" activeClassName="active">Daftar Staff Farmasi</NavLink>
								</li>
							</ul>
						</div>
					</nav>
					...
					<div className="container">
						<Switch>
							...
							<Route path="/all-staffFarmasi" exact component={DaftarStaffFarmasi} />
							<Route path="/update-pasien/:id" exact component={UpdatePasien} />
							<Route path="/lab-result/:id" exact component={AddLabResult} />
